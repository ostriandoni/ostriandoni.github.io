...
- Material Management
  - Implement Work Force Management (WFM) x Inventory Management System (IMS) x SAP Integration
  - Implement Bulk Material Liquidation for WFM 
  - Implement IMS x SAP Sync Movement
- Request Management
