...
title: "BNC"
date: 2025-01-02
description: "A banking service in the form of a digital application offered by Bank Neo Commerce."
image: bnc.png
tags:
  - IBM Db2
  - PostgreSQL
...
## Key Contributions
- Gathered and analyzed business requirements, translating Business Requirements Documents (BRD) into Product Requirements Documents (PRD)
- Led Scrum rituals including Daily Stand Up, Backlog Grooming, and Sprint Planning
- Facilitated User Acceptance Testing (UAT) with end users and produced UAT documentation
- Managed vendor selection cycles from Proof of Concept (PoC) to vendor scoring for treasury, IT risk management, customer service, and anti fraud applications
- Initiated product enhancements based on regulatory audit findings and reporting requirements
- Analyzed production issues to identify root causes and prevent recurrence
